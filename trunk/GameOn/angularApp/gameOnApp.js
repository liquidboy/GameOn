...
(function (GameOnApp) {
    ...
    var myapp = angular.module('gameOnApp', ['ngRoute', 'ngResource', 'ngAnimate']);
    ...
    myapp.config([
        '$routeProvider', '$locationProvider', '$httpProvider', '$provide', function ($routeProvider, $locationProvider, $httpProvider, $provide) {
            ...
            //$httpProvider.defaults.useXDomain = true;
            $locationProvider.html5Mode(true);
            $routeProvider.when('/Login', { templateUrl: '/angularApp/views/shared/Login.html' }).when('/Register', { templateUrl: '/angularApp/views/shared/Register.html' }).when('/About', { templateUrl: '/angularApp/views/about/About.html' }).when('/Home', { templateUrl: '/angularApp/views/home/Home.html', controller: 'HomeCtrl' }).when('/GameOS', { templateUrl: '/angularApp/views/GameOS/GameOS.html', controller: 'GameOSCtrl' }).when('/SharedOS', { templateUrl: '/angularApp/views/SharedOS/SharedOS.html', controller: 'SharedOSCtrl' }).when('/AppOS', { templateUrl: '/angularApp/views/AppOS/AppOS.html', controller: 'AppOSCtrl' }).when('/DirectX12', { templateUrl: '/angularApp/views/DirectX12/DirectX12.html', controller: 'DirectX12Ctrl' }).when('/XAML', { templateUrl: '/angularApp/views/XAML/XAML.html', controller: 'XAMLCtrl' }).when('/Error', { templateUrl: '/angularApp/views/shared/Error.html' }).otherwise({
                redirectTo: '/Home'
            });
