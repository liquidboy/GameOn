...
(function (Application) {
    ...
    (function (Controllers) {
        var ConfigListCtrl = (function () {
            function ConfigListCtrl($scope, $rootScope, serviceHelperSvc, dataSvc, instanceFactory) {
                var _this = this;
                this.$scope = $scope;
            ...
            ConfigListCtrl.prototype.UnSelect = function () {
        ...
        myapp.controller("ConfigListCtrl", ["$scope", "$rootScope", "serviceHelperSvc", "dataSvc", "instanceFactory", ConfigListCtrl]);
