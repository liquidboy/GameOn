...
(function (Application) {
    ...
    (function (Controllers) {
        var ConfigPostCtrl = (function () {
            function ConfigPostCtrl($scope, $rootScope, serviceHelperSvc, dataSvc, instanceFactory) {
                var _this = this;
                this.$scope = $scope;
        ...
        myapp.controller("ConfigPostCtrl", ["$scope", "$rootScope", "serviceHelperSvc", "dataSvc", "instanceFactory", ConfigPostCtrl]);
