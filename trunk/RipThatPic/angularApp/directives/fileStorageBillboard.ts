module Application.Directives {
    ...
    export class FileStorageBillboardDirective implements ng.IDirective {
        ...
        constructor(public pubSubConstants: Application.Constants.PubSubConstants,
            ...
            {                
                ...
                if (attributes.$attr["daIsMultipleSelection"]) this.scope.FSBIsMultipleSelection = element.attr(<string>attributes.$attr["daIsMultipleSelection"]) == "true" ? true : false;
        ...
        ItemSelected = (scope: IFileStorageBillboardScope, evt: any) => {
            ...
            $.each(scope.FSBSelectedItems,(index) => {
                var elm: any = scope.FSBSelectedItems[index];
                if ($(elm).data('id') === $(el).data('id')) {
                    foundItInList = el;
                }
            });

            if (scope.FSBIsMultipleSelection) { //MULTIPLE SELECTION
    ...
    export interface IFileStorageBillboardScope extends ng.IScope {
        ...
        FSBIsMultipleSelection: boolean;
