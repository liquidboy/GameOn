module Application.Directives {
    ...
    class Effect {
        ...
        NewTexture = function (passid, slot, url) {
    ...
    class EffectPass{
        ...
        NewShader = function (gl, shaderCode) {
        ...
        Destroy_Image = function (wa, gl) {
        }

        Create_Sound = function (wa, gl) {
            this.MakeHeader();
        ...
        MakeHeader = function (precission, supportDerivatives) {
