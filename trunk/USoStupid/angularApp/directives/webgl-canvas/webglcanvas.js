    ...
    (function (Directives) {
        ...
        var Camera = (function () {
            function Camera(element, mathUtils) {
                ...
                this.azimuth = this.INITIAL_AZIMUTH;
        ...
        var ShaderLib = (function () {
            function ShaderLib(FLOOR_ORIGIN, PARTICLE_SATURATION, PARTICLE_VALUE) {
                ...
                this.SIMULATION_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                ...
                this.RENDERING_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                ...
                this.RENDERING_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                    'varying vec3 v_position;',
                    'varying float v_opacity;',
                ...
                this.OPACITY_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                    'attribute vec2 a_textureCoordinates;',
                    'uniform sampler2D u_particleTexture;',
                ...
                this.OPACITY_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                    'uniform float u_particleAlpha;',
                    'void main () {',
                    'float distanceFromCenter = distance(gl_PointCoord.xy, vec2(0.5, 0.5));',
                ...
                this.SORT_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                    'attribute vec2 a_position;',
                    'void main () {',
                    'gl_Position = vec4(a_position, 0.0, 1.0);',
                ...
                this.SORT_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                ...
                this.RESAMPLE_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                    'attribute vec2 a_position;',
                ...
                this.RESAMPLE_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                    'varying vec2 v_coordinates;',
                    'uniform sampler2D u_particleTexture;',
                ...
                this.FLOOR_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                ...
                this.FLOOR_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                    'varying vec3 v_position;',
                    'uniform sampler2D u_opacityTexture;',
                    'uniform mat4 u_lightViewProjectionMatrix;',
                ...
                this.BACKGROUND_VERTEX_SHADER_SOURCE = [
                    'precision highp float;',
                    'attribute vec2 a_position;',
                ...
                this.BACKGROUND_FRAGMENT_SHADER_SOURCE = [
                    'precision highp float;',
                    'varying vec2 v_position;',
                    'void main () {',
        ...
        var FlowController = (function () {
            function FlowController($scope, $routeParams) {
                ...
                this.qualityLevel = -1;
                this.particleCountWidth = 0;
                this.particleCountHeight = 0;
            ...
            FlowController.prototype.render = function (currentTime) {
                ...
                if (this.changingParticleCount) {
                    ...
                    if (this.oldParticleCountHeight === 0 && this.oldParticleCountWidth === 0) {
                        ...
                        if (this.particleCount > this.oldParticleCountWidth * this.oldParticleCountHeight) {
